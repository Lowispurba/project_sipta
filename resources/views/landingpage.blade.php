  ...
  <body data-spy="scroll" data-target="#ftco-navbar" data-offset="200">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        ...
        <a class="navbar-brand" href="index.html">Teknologi Informasi</a>
    ...
    <section class="ftco-cover ftco-slant" style="background-image: url(images/Ta.jpg);" id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center ftco-vh-100">
          <div class="col-md-10">
            <b><h1 class="ftco-heading ftco-animate">Welcome to Website Teknologi Informasi</h1></b>
            <h3 class="text-white">Sistem Informasi Penjadwalan Tugas Akhir</h3>
            <p><a href="layout" target="_blank" class="btn btn-primary ftco-animate">Get Started</a></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <footer class="ftco-footer ftco-bg-dark">
            <p>&copy; 2024 Sistem Informasi penjadwalan Tugas Akhir<span class="icon-heart text-danger"></span>  by Muhammad Riski</a></p>
    </footer>
